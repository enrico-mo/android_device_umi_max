...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/prebuilts/.tp/bin/thermal:system/bin/thermal \
	$(LOCAL_PATH)/prebuilts/.tp/bin/thermal_manager:system/bin/thermal_manager \
	$(LOCAL_PATH)/prebuilts/.tp/bin/thermald:system/bin/thermald \
	$(LOCAL_PATH)/prebuilts/.tp/bin/thermalloadalgod:system/bin/thermalloadalgod
